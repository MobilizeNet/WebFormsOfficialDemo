...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="spacePrincipal">
        <div class="rowMenu">
            ...
            <div class="columnMenu" id="LinkButtonColumn">
                ...
                <p>
                    In this section you can test the
    ...
    <div class="spaceSecondary">
        <div class="rowMenu">
            ...
            <div class="columnMenu" id="eShopGridViewColumn">
                <div>
                    <h3 style="text-align: center"><strong>eShop GridView extender</strong></h3>
                </div>
                <p>In this section you can test the eShop demo gridview component.</p>
                <p style="float: right">
                    <a class="btn btn-default" runat="server" href="~/Features/eShopGridView">Go to Form &raquo;</a>
                </p>
            </div>
        </div>
    </div>
