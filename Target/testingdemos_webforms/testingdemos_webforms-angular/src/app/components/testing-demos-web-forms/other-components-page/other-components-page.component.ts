...
@Component({
   selector : "testing-demos-web-forms-other-components-page",
   styleUrls : ["./other-components-page.component.css"],
   templateUrl : "./other-components-page.component.html",
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["frmTestingDemos_WebFormsOtherComponents"])
export class OtherComponentsPageComponent extends PageComponent {
