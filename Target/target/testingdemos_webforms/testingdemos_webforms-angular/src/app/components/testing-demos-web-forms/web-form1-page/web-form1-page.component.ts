...
@Component({
   selector : "testing-demos-web-forms-web-form1-page",
   styleUrls : ["./web-form1-page.component.css"],
   templateUrl : "./web-form1-page.component.html",
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["frmTestingDemos_WebFormsWebForm1"])
export class WebForm1PageComponent extends PageComponent {
