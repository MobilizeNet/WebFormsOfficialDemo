...
@Component({
   selector : "testing-demos-web-forms-data-list-form-page",
   styleUrls : ["./data-list-form-page.component.css"],
   templateUrl : "./data-list-form-page.component.html",
   encapsulation : ViewEncapsulation.None
})
@dataTransfer(["frmTestingDemos_WebFormsDataListForm"])
export class DataListFormPageComponent extends PageComponent {
